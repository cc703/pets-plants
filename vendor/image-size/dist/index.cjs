...
// lib/lookup.ts
var globalOptions = {
  // image-size has no published fix for the ICNS/JXL/HEIF parser loops yet.
  // Keep the API compatible while preventing untrusted build inputs from reaching them.
  disabledTypes: ["heif", "icns", "jxl", "jxl-stream"]
};
